...
[project]
dependencies = [
    "py7zr>=1.1.3,<2.0.0",  # For multi-volume 7z extraction (resolving CVE-2026-23879)
    "multivolumefile>=0.2.3,<0.3.0",  # Required by py7zr
]
\end{lstlisting}
...
pip install "py7zr>=1.1.3,<2.0.0"
pip install "multivolumefile>=0.2.3,<0.3.0"
